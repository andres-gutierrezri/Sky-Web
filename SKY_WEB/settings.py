...
from SKY_WEB.local_settings import IS_DEPLOYED, DATABASE_DICT
from SKY_WEB.logging_settings import *
from SKY_WEB.cloud_settings import *
...
INSTALLED_APPS = [
    ...
    'Deliveries', # Primera Aplicación del Proyecto
]
